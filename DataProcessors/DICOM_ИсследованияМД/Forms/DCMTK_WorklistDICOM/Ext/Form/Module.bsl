...
Процедура ДополнитьУслугиОборудованиемСотрудника(Услуги, Врач)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               |	НоменклатураОборудованиеDICOM.Оборудование КАК Оборудование,
	               ...
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               |	ОборудованиеСотрудниковDICOM.Сотрудник КАК Сотрудник,
	               |	ОборудованиеСотрудниковDICOM.Оборудование КАК Оборудование
	               ...
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               |	ОборудованиеСотрудника.Сотрудник КАК Сотрудник,
	               |	ОборудованиеСотрудника.Оборудование КАК Оборудование,
	               |	ОборудованиеУслуг.Номенклатура КАК Номенклатура
	               |ИЗ
...
Процедура АвтозаполнитьИсследования(Данные, Услуги, Пациент)
	...
	Для каждого эл из Услуги Цикл
		...
		Строка.MODALITY		= эл.Номенклатура.DICOMModality;
	...
	|	Номенклатуры.DICOMModality КАК DICOMModality
	|ПОМЕСТИТЬ Услуги
	|ИЗ
	|	ОСУ КАК ОСУ
