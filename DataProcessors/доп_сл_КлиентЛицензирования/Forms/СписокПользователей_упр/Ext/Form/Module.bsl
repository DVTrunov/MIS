...
Процедура ЛокализироватьИнтерфейс();
	...
	ЛокализироватьИнтерфейсИзСтруктуры(доп_сл_общий.ПолучитьДанныеЛокализации(ТекущийЯзыкПользователя).доп_сл_КлиентЛицензирования.Форма_СписокПользователей); 
...
Процедура ПриОткрытии(Отказ)
	...
	Результат = доп_сл_сервер.ПолучитьСписокПользователей(ТекущиеПользователиИБ);
	
	Если Не Результат Тогда
	
		доп_сл_общий.ВывестиСообщение( доп_сл_общий.ПолучитьСтрокуСообщения("НедостаточноПравДляСпискаПользователей", Неопределено, ТекущийЯзыкПользователя) );
		Отказ = Истина;
