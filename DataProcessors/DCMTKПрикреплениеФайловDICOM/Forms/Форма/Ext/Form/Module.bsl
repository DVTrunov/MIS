...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НастройкиDICOM = DICOMРаботаСДрайвером.ПолучитьНастройки("DCMTK_STORESCP_КаталогФайлов, STORESCP_ИспользоватьКлиент");
	
	Если НастройкиDICOM.STORESCP_ИспользоватьКлиент = Истина Тогда
		НастройкиDICOM_КаталогФайлов = НастройкиDICOM.DCMTK_STORESCP_КаталогФайлов;
	Иначе
		Попытка
			НастройкиDICOM_КаталогФайлов = Константы.DCMTK_STORESCP_КаталогФайлов.Получить();
		Исключение
