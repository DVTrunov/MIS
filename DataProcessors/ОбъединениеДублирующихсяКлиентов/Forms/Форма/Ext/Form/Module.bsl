...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Оригинал") Тогда
		НаЧтоЗаменять = Параметры.Оригинал;	
	КонецЕсли;
	
	Если Параметры.Свойство("Дубль") Тогда
		ЧтоЗаменять = Параметры.Дубль;	
	КонецЕсли;
...
Процедура КомандаВыполнитьНажатие(Команда)
	...
	Если Ответ=КодВозвратаДиалога.Да Тогда
		доп_ПолныеПрава.ОбъединитьДвухПациентов(НаЧтоЗаменять, ЧтоЗаменять, ДанныеДубляБолееАктуальны);
