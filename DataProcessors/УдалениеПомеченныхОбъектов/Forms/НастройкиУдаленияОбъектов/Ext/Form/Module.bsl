...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//КонецЕсли;
	Элементы.НастройкаРегламентногоУдаления.Видимость = Ложь;
	//-ОЛИМП
...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.ФормаГруппаУдаляемыеОбъекты.Видимость = Ложь;
    //-ОЛИМП
КонецПроцедуры
...
Процедура ДобавитьНастройкуСервер(Результат)
	...
	Для Каждого Элемент Из Результат Цикл
		...
		Если ДеревоМестПоиска.Строки.НайтиСтроки(Фильтр).Количество() = 0 Тогда
			...
			//+ОЛИМП
			//МестоПоиска.МестоПоискаРеквизитПредставление = Элемент.Представление;
			МестоПоиска.МестоПоискаРеквизитПредставление = Элемент.Значение;
			//-ОЛИМП
			МестоПоиска.Картинка = Картинка;
		КонецЕсли;
	КонецЦикла;
