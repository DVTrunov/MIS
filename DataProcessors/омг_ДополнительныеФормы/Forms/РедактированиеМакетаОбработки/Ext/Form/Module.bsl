...
Процедура ОКНаСервере()
	...
	ШаблонОбъект = Параметры.Шаблон.ПолучитьОбъект();
	ШаблонОбъект.СписокИзображений.Загрузить(СписокИзображений.Выгрузить());
	...
	ИначеЕсли ВидЭлемента = "Картинка" Тогда
		...
		Если ДиалогОткрытияФайла.Выбрать() Тогда
			...
			Если ИдентификаторИзображения <> Неопределено Тогда
				Картинка = Элементы.Документ.Документ.createElement("image");
