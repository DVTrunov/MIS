...
Функция ПолучитьСписокРеквизитовСправочника(ИмяСправочника, ИсходныйКлючЗаписи)
	...
	НедоступныеРеквизиты = ПолучитьРеквизитыНедоступныеДляОбязательногоЗаполнения(ИмяСправочника);
	...
	Для Каждого Реквизит Из Метаданные.Справочники[ИмяСправочника].Реквизиты  Цикл
		...
		Если (СписокИспользованныхРеквизитов.Найти(Реквизит.Имя) = Неопределено
			...
			И НедоступныеРеквизиты.Найти(Реквизит.Имя) = Неопределено
		Тогда	
...
&НаСервереБезКонтекста
Функция ПолучитьРеквизитыНедоступныеДляОбязательногоЗаполнения(ИмяСправочника)
	
	МассивРеквизитов = Новый Массив;
	
	Попытка
		Макет = Справочники[ИмяСправочника].ПолучитьМакет("РеквизитыНедоступныеДляОбязательногоЗаполнения"); 
	Исключение
	...
	Для Сч = 2 По Макет.ВысотаТаблицы Цикл
		...
		ИмяРеквизита = Макет.Область(Сч, 1, Сч, 1).Текст;
