...
&НаКлиенте
Процедура ИнтеграцияЕГИСЗРезервноеКопированиеНажатие(Элемент)
	
	ОткрытьФорму("Обработка.РегламентныеИФоновыеЗадания.Форма.РегламентноеЗадание", Новый Структура("Идентификатор, Действие", ИдентификаторРегЗаданияРезервногоКопирования(), "Изменить"));
...
&НаСервереБезКонтекста
Функция ИдентификаторРегЗаданияРезервногоКопирования()
	Возврат РегламентныеЗадания.НайтиПредопределенное("ИнтеграцияЕГИСЗРезервноеКопирование").УникальныйИдентификатор;
КонецФункции
