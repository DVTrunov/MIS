...
Процедура ПриПолученииНастроек(НастройкиПланаОбмена) Экспорт
	...
	НастройкиПланаОбмена.ИмяКонфигурацииПриемника.Вставить("БухгалтерияДляКазахстана");
...
Процедура ПриПолученииВариантовНастроекОбмена(ВариантыНастроекОбмена, ПараметрыКонтекста) Экспорт
	...
	ВариантНастройки.ИдентификаторНастройки        = "ОбменБПУМЦ";
...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "БухгалтерияДляКазахстана";
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента = НСтр("ru = 'Бухгалтерия для Казахстана ред. 3'");
...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат "Настройки обмена УМЦ-БК3";
...
Процедура ИнициализироватьРежимВыгрузкиПриНеобходимости() Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      |	БК.Ссылка КАК Ссылка
	                      |ИЗ
	                      |	ПланОбмена.омг_ОбменУМЦБухгалтерияПредприятия30 КАК БК
	                      |ГДЕ
	                      |	БК.Ссылка <> &ЭтотУзел
	                      |	И ВЫБОР
	                      |			КОГДА БК.РежимВыгрузкиПриНеобходимости <> ЗНАЧЕНИЕ(Перечисление.РежимыВыгрузкиОбъектовОбмена.ВыгружатьПриНеобходимости)
	                      |				ТОГДА ИСТИНА
	                      |			ИНАЧЕ ЛОЖЬ
	                      |		КОНЕЦ = ИСТИНА");
...
Функция КраткаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные между конфигурацией Управление медицинским центром и Бухгалтерия для Казахстана ред. 3. 
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	Возврат "ПланОбмена.омг_ОбменУМЦБухгалтерияПредприятия30.Форма.ПодробнаяИнформация";
КонецФункции

Функция ИмяКонфигурацииИсточника() Экспорт
	
	Возврат "УправлениеМедицинскимЦентром";
