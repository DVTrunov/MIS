//+ОЛИМП 
// Помимо изменения модуля добавлены реквизиты формы доп_ФлагЗацикливания и ТекстСообщения.
//-ОЛИМП
...
Процедура ОперацияЗавершение(РезультатВыполнения, Параметры) Экспорт
	...
	доп_ФлагЗацикливания = Ложь;
	ТекстСообщения = ТекстСообщения;  
	
	//Если Параметры.Команда = "ЗакрытьСмену" и РезультатВыполнения.Результат Тогда
	//омг_РаботаСРеестрамиКлиент.ЗакрытьСмену();	
	//КонецЕсли;		
	...
	Если РезультатВыполнения.Результат Тогда 
		...
		Если ДопПараметры.Команда = "ОткрытьСмену" Тогда
			...
			ИначеЕсли РезультатВыполнения.СтатусСмены = 1 Тогда
				...
				Если доп_ФлагЗацикливания Тогда
					доп_ФлагЗацикливания = Ложь;
...
&НаКлиенте
Процедура омг_ДанныеКассы(Команда)
	ОткрытьФорму("Отчет.омг_ДанныеКассы.Форма");
	Закрыть();
КонецПроцедуры
