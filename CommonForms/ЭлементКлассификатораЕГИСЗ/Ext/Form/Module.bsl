...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Реквизит Из МетаданныеСправочника.Реквизиты Цикл
		...
		Тогда
			Попытка
				ДобавитьПолеВводаРеквизита(Реквизит.Имя, Реквизит.Тип, Реквизит.Представление(), Реквизит.ПараметрыВыбора);
...
Процедура ЗаполнитьОсновныеРеквизиты()
	...
	Если ЗначениеЗаполнено(Источник) Тогда
		...
		Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Источник, "Атрибуты")
			И (Ссылка.Метаданные().ТабличныеЧасти.Атрибуты.Использование <> Метаданные.СвойстваОбъектов.ИспользованиеРеквизита.ДляЭлемента
			Или Не Ссылка.ЭтоГруппа)
		Тогда
...
&НаСервере
Процедура ДобавитьПолеВводаРеквизита(ИмяРеквизита, Тип, Представление, ПараметрыВыбора)
	...
	ПолеВвода.АвтоМаксимальнаяШирина = Ложь;
	ПолеВвода.ПараметрыВыбора = ПараметрыВыбора;
...
Функция КлассификаторыЗапрещенРучнойВвод()
	...
	Тогда
		ИменаСправочников.Добавить("ВидыМедицинскихДокументов");
