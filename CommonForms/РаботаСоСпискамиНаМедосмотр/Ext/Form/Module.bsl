...
Процедура УстановитьОтборПоФИО(ЗначениеПоиска = Неопределено, ЭлементФормыОтбора = Неопределено)
	...
	Если ДляСправок Тогда
		...
		КонецЕсли;
	Иначе
		ОбщегоНазначенияБИТКлиентСервер.УстановитьПараметрКомпоновкиЕслиИзменился(Список.Параметры, "ИспользуетсяОтборПоФИО", ИспользуетсяОтборПоФИО);
		Если ИспользуетсяОтборПоФИО Тогда
			ОбщегоНазначенияБИТКлиентСервер.УстановитьПараметрКомпоновкиЕслиИзменился(Список.Параметры, "ТекстОтборФИО", ЗначениеПоиска + "%");
		КонецЕсли;
	КонецЕсли;
...
Процедура УстановитьОтборПоПрМО(ЗначениеПоиска = Неопределено, ЭлементФормыОтбора = Неопределено)
	...
	Если ДляСправок Тогда
		...
		КонецЕсли;
	Иначе
		ОбщегоНазначенияБИТКлиентСервер.УстановитьПараметрКомпоновкиЕслиИзменился(Список.Параметры, "ИспользуетсяОтборПоПрМО", ИспользуетсяОтборПоПрМО);
		Если ИспользуетсяОтборПоПрМО Тогда
			ОбщегоНазначенияБИТКлиентСервер.УстановитьПараметрКомпоновкиЕслиИзменился(Список.Параметры, "ОтборПрМО", "%" + ЗначениеПоиска + "%");
		КонецЕсли;
	КонецЕсли;
