...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокСкорость.Добавить(4800,   НСтр("ru = '4800 бод'"));
	СписокСкорость.Добавить(9600,   НСтр("ru = '9600 бод'"));
	СписокСкорость.Добавить(14400,  НСтр("ru = '14400 бод'"));
	СписокСкорость.Добавить(19200,  НСтр("ru = '19200 бод'"));
	СписокСкорость.Добавить(28800,  НСтр("ru = '28800 бод'"));
	СписокСкорость.Добавить(38400,  НСтр("ru = '38400 бод'"));
	СписокСкорость.Добавить(57600,  НСтр("ru = '57600 бод'"));
	СписокСкорость.Добавить(115200, НСтр("ru = '115200 бод'"));
