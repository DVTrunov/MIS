...
Процедура ОповеститьОВыбореКлиента(Клиент)
	...
	Если ВладелецФормы <> Неопределено Тогда
		...
		Если Клиент <> ПредопределенноеЗначение("Справочник.Клиенты.Резерв") Тогда
...
Процедура ВыбратьРезерв(Команда)
    СсылкаНаРезерв = ПредопределенноеЗначение("Справочник.Клиенты.Резерв");
    
    ОповеститьОВыбореКлиента(СсылкаНаРезерв);
КонецПроцедуры
