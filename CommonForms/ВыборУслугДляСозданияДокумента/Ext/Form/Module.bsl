...
Функция ИсключитьДублиИзРазныхИсточниковВыполнения(ТаблицаДанныхПриемы, ИсходныеДанныеПрочихИсточников)
	...
	Для Каждого ТаблицаИсточник Из ИсходныеДанныеПрочихИсточников Цикл
		...
		КонецЦикла;
	КонецЦикла;
	ДопСерверныеФункции.СвернутьТаблицуЗначений(ТаблицаПрочиеИсточники, "Количество");
	...
	КонецЦикла;
	ДопСерверныеФункции.СвернутьТаблицуЗначений(ТаблицаДанныхПриемы, "Количество");
