...
Процедура ОбработкаЗаполнения(Основание)
	...
	ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.Заявка") Тогда
		...
		СтатусСуществующей = омг_Предоплата.ПолучитьСтатусПредоплаты(Основание);
		...
		Тогда
			ВызватьИсключение "По заявке " + Основание + " уже существует активная предоплата (документ "
		...
		Если ВыборкаДетальныеЗаписи.Следующий() Тогда
			...
			Исключение
				ЗаписьЖурналаРегистрации("ПриходныйКассовыйОрдер.ОбработкаЗаполнения", УровеньЖурналаРегистрации.Ошибка,,,
					"Заявка=" + Основание + "; " + ОписаниеОшибки());
			КонецПопытки;
