...
Процедура СкопироватьГрафикиПонедельно(ПараметрыЗаполнения) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ТаблицаСотрудников.Сотрудник КАК ОбъектРасписания,
	|	ГрафикиРаботы.Смена,
	...
	Пока ВыборкаСотрудники.Следующий() Цикл
		...
		РезультатПоиска = ЭтотОбъект.Участники.НайтиСтроки(Новый Структура("Участник",ВыборкаСотрудники.ОбъектРасписания));
		...
		НовыйУчастник.Участник = ВыборкаСотрудники.ОбъектРасписания;
