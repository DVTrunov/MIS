...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.Отработан.Доступность			= РольДоступна("ПолныеПрава") Или РольДоступна("доп_ПользовательБИТфон");
	Элементы.НазначитьОтработку.Доступность	= РольДоступна("ПолныеПрава") Или РольДоступна("доп_ПользовательБИТфон");
...
Процедура НачатьРазговор(Команда)
	...
	Если Команда.Имя = "НачатьРазговор" Тогда
		доп_ТелефонияКлиентПереопределяемый.Позвонить(НомерТелефона, , Объект.Ссылка);
	Иначе
		доп_ТелефонияКлиентПереопределяемый.ПозвонитьМонитор(НомерТелефона, , Объект.Ссылка);
	КонецЕсли;
