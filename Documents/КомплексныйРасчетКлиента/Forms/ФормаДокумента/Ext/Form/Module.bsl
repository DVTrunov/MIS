...
&НаКлиенте
Перем стомВыделенныеЗубы;

&НаКлиенте
Перем ФайлПриложенияSL;

&НаКлиенте
Перем ПриложениеSLЗагружено;

&НаКлиенте
Перем ЕстьПравоРедактированияЗубнойКарты;
...
Процедура ПриОткрытии(Отказ)
	...
	#Область Стоматология
	ЕстьПравоРедактированияЗубнойКарты = стомСтоматология.ЕстьПравоРедактированияЗубнойКарты();
	#КонецОбласти
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ОбработатьКонструкцииПередЗаписью();
...
Процедура ПроверитьУстановитьДоступностьЭлементовПроизводственногоЗаказа()
	...
	#Область Стоматология
	ЭтоЗуботехническийЗаказ = ЭтоЗаказНаПроизводство И УправлениеЗаказами.ЭтоЗуботехническийЗаказ(Объект.Вид);
	Элементы.стомГруппаЗаказНаряд.Видимость = ЭтоЗуботехническийЗаказ;
	Элементы.стомДоступныеВарианты.ТолькоПросмотр = Не ЕстьПравоРедактированияЗубнойКарты;
	Элементы.стомУстановленныеКонструкции.ТолькоПросмотр = Не ЕстьПравоРедактированияЗубнойКарты;
	#КонецОбласти
...
&НаКлиенте
Процедура ИнициализироватьЗубнуюКарту()
	
	Если стомДанныеЗубныхКарт <> Неопределено Тогда
		ИнициализироватьЗубнуюКартуСервер();
...
Процедура ИнициализироватьЗубнуюКартуСервер()
	...
	Элементы.стомГруппаЗаказНаряд.Видимость = Не ДанныеВидаРасчета.ПустаяСсылка И ДанныеВидаРасчета.ЭтоЗуботехническийЗаказНаряд;
	Элементы.ЗубнаяКарта.Видимость = стомСтоматология.ВедетсяНесколькоЗубныхКарт();
...
&НаСервере
Процедура ОбработатьКонструкцииПередЗаписью()
...
&НаКлиенте
Процедура ПриВыделенииЗубовСегментов(ВыделенныеЗубыСегментыJS, ОбновлятьВарианты = Истина)
	...
	ДанныеОВыделении = стомЗубнаяКартаМетоды.ПолучитьДанныеОВыделенныхЗубахСегментах(
		стомДанныеЗубныхКарт.Адрес, ВыделенныеЗубыСегментыJS, ОбновлятьВарианты, Ложь);
...
&НаКлиенте
Процедура стомДоступныеВариантыУстановленоПриИзменении(Элемент)
...
Процедура КлиентПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.Клиент) Тогда 
		Если Не ЗначениеЗаполнено(Объект.ЗубнаяКарта) Тогда
			КартаВариант = стомСтоматология.ПолучитьВидВариантЗубнойКарты(Объект.Клиент);
			Объект.ЗубнаяКарта = КартаВариант.ЗубнаяКарта;
			Объект.ВариантЗубнойКарты = КартаВариант.ВариантЗубнойКарты;
		КонецЕсли;
