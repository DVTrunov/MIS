...
Функция ПолучитьДанныеОказанияУслугДляВводаПриема(ОУСсылка)
	...
	// ОМГ        
	Естьомг_Набор = Ложь;
	Если не ОУСсылка.Метаданные().ТабличныеЧасти.Работы.Реквизиты.Найти("омг_Набор") = Неопределено Тогда
		Естьомг_Набор = Истина
	КонецЕсли;
	// ОМГ  
	///////////////////////////////////////////////////////////////////////////
	...
	Если Естьомг_Набор Тогда
		 ДанныеРаботы.Вставить("омг_Набор", СтрокаТЧ.омг_Набор);
	КонецЕсли;	
	// ОМГ  
	///////////////////////////////////////////////////////////////////////////
