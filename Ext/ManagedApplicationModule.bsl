...
Процедура ПередНачаломРаботыСистемы(Отказ)
	...
	КонецЕсли; 
		// Добавлено Карсаков (
	Если омг_МедицинскаяДеятельность.омг_РольДоступна("омг_АРМРегистратора") Тогда 
...
Процедура ПриНачалеРаботыСистемы() 
	...
	// ) 
	// Добавлено Карсаков (
	Если омг_МедицинскаяДеятельность.омг_РольДоступна("омг_АРМРегистратора") или омг_МедицинскаяДеятельность.омг_РольДоступна("омг_АРМАдминистратор") 
		или омг_МедицинскаяДеятельность.омг_РольДоступна("омг_АРМ_Врач") или омг_МедицинскаяДеятельность.омг_РольДоступна("омг_АРМ_Медперсонал") или омг_МедицинскаяДеятельность.омг_РольДоступна("омг_Оператор")
		или омг_МедицинскаяДеятельность.омг_РольДоступна("омг_АРМОператор") Тогда
		омг_МедицинскаяДеятельность.НастроитьИнтерфейсДляРегистратора();
		ОбновитьИнтерфейс();
	КонецЕсли;
	// )
