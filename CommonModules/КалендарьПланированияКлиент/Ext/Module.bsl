...
//
Процедура ОткрытьДиалогПричиныОтменыЗаявки(ЗаявкаСсылка, СостояниеОтмены = Неопределено, ОписаниеОповещения = Неопределено) Экспорт
	...
	ФормаЗаписи.ОписаниеОповещенияОЗакрытии = ОписаниеОповещения;
	ФормаЗаписи.Открыть();	
