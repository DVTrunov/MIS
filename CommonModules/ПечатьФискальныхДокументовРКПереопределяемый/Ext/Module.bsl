...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Форма.ИмяФормы = "РегистрСведений.ФискальныеОперацииРК.Форма.ФормаЗаписи" Тогда
...
Функция ПолучитьРеквизитыКассира(ПараметрыФормы) Экспорт
	...
	ДанныеКассира = омг_WebKassa.ДанныеФизЛицаТекущегоПользователя(ПараметрыФормы.Организация);
