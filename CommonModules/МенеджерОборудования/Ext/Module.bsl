...
Функция ДобавитьВСправочникВнешнихКомпонентИзМакетаСлужебный(ДляДобавленияВоВнешниеКопонентыИзМакета) Экспорт
	...
	Для Каждого Данные Из ДляДобавленияВоВнешниеКопонентыИзМакета Цикл
...
//
// Возвращаемое значение:
//   Масив из ПеречислениеСслыка.ТипыПодключаемогоОборудования
//
