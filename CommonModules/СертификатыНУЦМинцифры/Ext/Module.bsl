...
Функция ВерсияБСПДопустимаДляУстановкиКорневыхСертификатов() Экспорт
	...
	//+ОЛИМП Пока это нужно для того чтобы отображался раздел установки в обработке ПанельАдминистрированияБПО, 
	// при дальнеших обновлениях если где-то еще будет требоваться эта процедура возможно нужна будет адаптация
	Возврат Истина;
	//-ОЛИМП
