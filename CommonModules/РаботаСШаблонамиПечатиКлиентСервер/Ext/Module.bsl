...
// Возвращает префикс стандартных алгоритмов
// 
// Возвращаемое значение:
//  Строка - Префикс стандартных алгоритмов
//
Функция ПрефиксСтандартныхАлгоритмов() Экспорт

	Возврат "СТАНДАРТНЫЕ_АЛГОРИТМЫ_";
