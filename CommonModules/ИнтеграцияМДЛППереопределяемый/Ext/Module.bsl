...
Процедура РассчитатьСтатусОформленияУведомленияОРозничныхПродажах(ДокументОснование) Экспорт
	...
	ЗапрашиваемыеРеквизиты.Вставить("МестоДеятельности", СкладыБИТ.ИмяРеквизитаСкладОтправитель(ДокументОснование));
...
Процедура РассчитатьСтатусОформленияУведомленияОПриемке(ДокументОснование) Экспорт
	...
	// +ОЛИМП
	ЗапрашиваемыеРеквизиты = ИнтеграцияМДЛПМедицина_БИТ.СтруктураРеквизитыРасчетаСтатусаОформления();	
	ЗапрашиваемыеРеквизиты.МестоДеятельности = СкладыБИТ.ИмяРеквизитаСкладОтправитель(ДокументОснование);
