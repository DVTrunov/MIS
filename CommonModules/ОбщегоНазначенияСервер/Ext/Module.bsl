...
Функция ПолучитьСоставНабора(Ном) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      ...
	                      |	НоменклатураКомплектующиеНоменклатуры.ХарактеристикаКомплектующей КАК ХарактеристикаКомплектующей,
	                      |	НоменклатураКомплектующиеНоменклатуры.Количество КАК Количество,
	                      |	НоменклатураКомплектующиеНоменклатуры.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	                      |	ВЫБОР
	                      ...
	                      |		ИНАЧЕ ЛОЖЬ
	                      |	КОНЕЦ КАК ЭтоТовар,
	                      |	НоменклатураКомплектующиеНоменклатуры.Ссылка КАК Ссылка,
	                      |	НоменклатураКомплектующиеНоменклатуры.Ссылка В ИЕРАРХИИ
	                      |		(ВЫБРАТЬ
	                      |			ВТ_НастройкиЛИС.ГруппаНоменклатуры КАК ГруппаНоменклатуры
	                      |		ИЗ
	                      |			ВТ_НастройкиЛИС КАК ВТ_НастройкиЛИС) КАК ЭтоНаборЛИС
	                      |ИЗ
	...
	//////////////////////////////////////////////////////////////////
	//ОМГ
	    нс.Вставить("омг_Набор"	, Ном);
	    нс.Вставить("ЭтоНаборЛИС", выборка.ЭтоНаборЛИС);
	//ОМГ 
	//////////////////////////////////////////////////////////////////
...
// Получает данные из динамического списка и возвращает в виде таблицы значений
//
// Параметры:
//  Список	 - Элемент - Элемент динамического списка
// 
// Возвращаемое значение:
//  ТаблицаЗначений - 
//
Функция ПолучитьДанныеДинамическогоСписка(Список) Экспорт
	...
	Возврат ПроцессорВывода.Вывести(ПроцессорКомпоновки, Истина);
