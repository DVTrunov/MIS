...
// Функция - Значение свойства объекта
//
// Параметры:
//  Владелец - ДокументСсылка.Заявка, СправочникСсылка	 - см. РегистрСведений.ЗначенияСвойствОбъектов.Объект. 
//  Свойство - Строка, ПланВидовХарактеристикСсылка.СвойстваОбъектов - код свойства или ссылка.
// 
// Возвращаемое значение:
//  Неопределено, ПланВидовХарактеристик.СвойстваОбъектов.ТипЗначения - значение свойства.
//
Функция ЗначениеСвойстваОбъекта(Владелец, Свойство) Экспорт
	
	Перем СвойствоСсылка;
