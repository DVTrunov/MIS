...
Функция ПрочитатьСтрокуJSON(СтрокаJSON, ПрочитатьВСоответствие = Ложь) Экспорт
	...
	Возврат ОбщегоНазначенияБИТКлиентСервер.ПрочитатьСтрокуJSON(СтрокаJSON, ПрочитатьВСоответствие);
	
КонецФункции

Функция СформироватьСтрокуJSON(Значение) Экспорт
	
	Возврат ОбщегоНазначенияБИТКлиентСервер.СформироватьСтрокуJSON(Значение);
	
КонецФункции

Функция ПреобразованиеJSON(Знач Свойство, Значение, ДополнительныеПараметры, Отказ) Экспорт
	
	Возврат ОбщегоНазначенияБИТКлиентСервер.ПреобразованиеJSON(Свойство, Значение, ДополнительныеПараметры, Отказ);
