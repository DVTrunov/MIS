...
Процедура УстановитьОбщиеНастройкиВхода(ОбщиеСохраняемыеНастройки) Экспорт
	...
	Блокировка.Добавить("Константа.омг_НастройкиВходаПользователей");
	...
	Попытка
		...
		Константы.омг_НастройкиВходаПользователей.Установить(Новый ХранилищеЗначения(НастройкиВхода));
