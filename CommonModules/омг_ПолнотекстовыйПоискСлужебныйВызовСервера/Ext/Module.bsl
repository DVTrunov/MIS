...
Функция УстановитьРежимПолнотекстовогоПоиска(ИспользоватьПолнотекстовыйПоиск) Экспорт
	...
	Попытка
		Константы.омг_ИспользоватьПолнотекстовыйПоиск.Установить(ИспользоватьПолнотекстовыйПоиск);	
	Исключение
		Возврат Ложь;
	КонецПопытки;
...
Функция ЗначениеФлажкаИспользоватьПоиск() Экспорт
	...
	Возврат омг_ПолнотекстовыйПоискСервер.ЗначениеФлажкаИспользоватьПоиск();
