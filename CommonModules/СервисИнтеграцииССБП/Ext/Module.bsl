...
//
Функция КассоваяСсылка(ПараметрыИнтеграции, ИдентификаторОплаты = Неопределено) Экспорт //+ОЛИМП добавлен ИдентификаторОплаты
	
	Возврат ОперацияРегистрацияКассовойСсылки(ПараметрыИнтеграции, ИдентификаторОплаты); //+ОЛИМП
...
//    *ИнформацияОбОшибке - Строка, ФорматированнаяСтрока - сообщение об ошибке для администратора.
//
Функция ОперацияРегистрацияКассовойСсылки(ПараметрыИнтеграции, ИдентификаторОплаты) //+ОЛИМП добавлен ИдентификаторОплаты
	...
	РезультатОтправки = ВызовОперацииРегистрацияКассовойСсылки(
		...
		РезультатПлатежнаяСистема.Аутентификация,
		URLОперации,
		ИдентификаторОплаты); //+ОЛИМП добавили ИдентификаторОплаты
...
Функция cash_register_qrs_register_qr(
	...
	//+ОЛИМП
	Если ЗначениеЗаполнено(ИдентификаторОплаты) Тогда
		ЗаписьДанныхСообщения.ЗаписатьИмяСвойства("qrId");
