...
//+ОЛИМП.Взята из БПО, т.к. в БСП отдельная менее надежная компонента.
...
Функция ПакетСОднимТабличнымДокументом(ТабличныйДокумент)
	...
	//+ОЛИМП Совместно с УправлениеПечатьюКлиент.РаспечататьТабличныеДокументы() дает более простой выбор неоснвного принтера для печати.
