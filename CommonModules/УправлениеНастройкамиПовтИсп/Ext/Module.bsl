...
Функция ПолучитьУчетнуюПолитикуРасширеннуюПоУмолчанию() Экспорт
	...
	СтруктураВозврата.Вставить("КонтролироватьЗаполнениеШКМаркированногоТовараПриПродаже", 2);
	СтруктураВозврата.Вставить("ЛокальнуюПроверкуМаркировкиНаККТИспользовать", Истина);
