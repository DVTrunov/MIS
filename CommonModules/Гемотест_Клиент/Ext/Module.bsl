	...
	Иначе
		...
		ИначеЕсли ТипЗнч(Результат) = Тип("Структура") Тогда
			...
			Для Каждого Элемент Из Результат.мШтрихКодов Цикл
				...
				НоваяСтрока.Контейнер = Строка(Элемент.localization_name);
				НоваяСтрока.КонтейнерПредставление = Строка(Элемент.transport_name);
				НоваяСтрока.Биоматериал = Строка(Элемент.sample_description);
				НоваяСтрока.БиоматериалПредставление = Строка(Элемент.biomaterial_name);
				НоваяСтрока.Лаборатория = Лаборатория;
				НоваяСтрока.ИдПравила = Строка(Элемент.id_lab_center);
