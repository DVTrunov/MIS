...
Процедура ИнтернетПоддержкаИСервисы_ПриСозданииНаСервере(Форма) Экспорт
	...
	Если Элементы.БИППодключатьсяКСерверамВЗонеEu.Видимость Тогда
		//+ОЛИМП. Не интегрированная часть БИП. Убрано.
...
Процедура ПриЗаполненииРазрешенийНаДоступКВнешнимРесурсам(ЗапросыРазрешений) Экспорт
	...
	Если НЕ ОбщегоНазначения.РазделениеВключено() Тогда
		...
		//ЗапросыРазрешений.Добавить(РаботаВБезопасномРежиме.ЗапросНаИспользованиеВнешнихРесурсов(НовыеРазрешения)); //+ОЛИМП Не интегрировано.
