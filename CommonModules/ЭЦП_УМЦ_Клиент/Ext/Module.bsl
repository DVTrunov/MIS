...
Процедура ПерейтиКПодписаниюЭМД(Форма, РасширеннаяФормаПодписания = Ложь, ТребуетсяПроведениеДокумента = Истина, ПроверкаРЭМД = Истина, СсылкаНаДокумент = Неопределено, РежимОткрытияОкна = Неопределено) Экспорт
	
	ДопПараметры = Новый Структура;
	ДопПараметры.Вставить("РасширеннаяФормаПодписания",	РасширеннаяФормаПодписания);
...
Процедура ПерейтиКПодписаниюЭМДПродолжение(Результат, Параметры) Экспорт
	...
	ПерейтиВФормуРаботыСЭМД(Параметры.МедицинскийДокумент, Параметры.ИдентификаторФормы, Параметры.РасширеннаяФормаПодписания, Параметры.Форма, Параметры.РежимОткрытияОкна);
...
Процедура ПерейтиВФормуРаботыСЭМД(МедицинскийДокумент, ИдентификаторФормы, РасширеннаяФормаПодписания, Владелец, РежимОткрытияОкна)
	...
	ПараметрыЭМД.Вставить("РасширеннаяФормаПодписания",		РасширеннаяФормаПодписания);
