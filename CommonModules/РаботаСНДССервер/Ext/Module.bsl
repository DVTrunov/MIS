...
//   ТаблицаЗначений.
//
Функция ПолучитьПродажиСоответствующиеОтбору(ТаблицаПродажДокумента, НастройкаСсылка, Дата = Неопределено, ВидОтбора = "ОтборПатент") Экспорт
...
//
Функция ПолучитьПродажиПоДополнительнойСНО(ТаблицаПродажДокумента, НастройкаСсылка, Дата, ВидОтбора = "ОтборПатент") Экспорт 
...
//   Массив.
//
Функция ЗаполнитьПризнакПатентДляНоменклатуры(Знач Объект, НастройкаПечатиЧеков) Экспорт
