	...
	Для Каждого ВидСегментации Из ВидыСегментации Цикл
		...
		Пока ЕстьОстатокКлиентов Цикл
			...
			Для Каждого Правило Из ВидСегментации.Ссылка.ПравилаСегментации Цикл 
				...
				// Если вся порция клиентов получила свои сегменты, то не продолжаем вычисление по строкам правил сегментации,
				// а переходим к следующей порции клиентов (при наличии).
