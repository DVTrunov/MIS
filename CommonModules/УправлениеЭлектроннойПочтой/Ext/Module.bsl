...
Функция ПолучитьПараметрыОтправкиПриемаПоЭлектроннойПочте(Знач ПриемыКОтправке, Тема, Текст, Клиент, ВложениеHTML = Неопределено) Экспорт
	...
	Если ПриемыКОтправке.Количество() > 0 Тогда
		...
		Если ВложениеHTML = Неопределено Тогда
			...
			ДанныеШаблонов = ПолучитьДанныеШаблоновДляОтправкиПоЭлектроннойПочте(ПриемыКОтправке);
...
Функция ПолучитьДанныеШаблоновДляОтправкиПоЭлектроннойПочте(ПриемыКОтправке) Экспорт
	...
	соотвКешИзображенийШаблонов = РаботаСШаблонамиHTML.ПолучитьКешИзображенийПриема(МассивШаблонов, Неопределено, Истина);
