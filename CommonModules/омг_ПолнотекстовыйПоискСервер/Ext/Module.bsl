...
Функция СостояниеПолнотекстовогоПоиска() Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("омг_ИспользоватьПолнотекстовыйПоиск") Тогда 
...
Функция ФункциональнаяОпцияИспользоватьПолнотекстовыйПоиск() Экспорт
	...
	Возврат Метаданные.ФункциональныеОпции.омг_ИспользоватьПолнотекстовыйПоиск;
...
Функция ИспользоватьПолнотекстовыйПоиск() Экспорт
	...
	Возврат ПолучитьФункциональнуюОпцию("омг_ИспользоватьПолнотекстовыйПоиск");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Если Не ПолучитьФункциональнуюОпцию("омг_ИспользоватьПолнотекстовыйПоиск")
	...
	Если Раздел = Неопределено Тогда
		Разделы = МодульТекущиеДелаСервер.РазделыДляОбъекта(Метаданные.Обработки.омг_ПолнотекстовыйПоискВДанных.ПолноеИмя());
	...
	Дело.Форма = "Обработка.омг_ПолнотекстовыйПоискВДанных.Форма.УправлениеПолнотекстовымПоискомИИзвлечениемТекстов";
	Дело.Подсказка = 
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Зависимость.РегламентноеЗадание = Метаданные.РегламентныеЗадания.омг_ОбновлениеИндексаППД;
	Зависимость.ФункциональнаяОпция = ФункциональнаяОпцияИспользоватьПолнотекстовыйПоиск();
	
	Зависимость = Настройки.Добавить();
	Зависимость.РегламентноеЗадание = Метаданные.РегламентныеЗадания.омг_СлияниеИндексаППД;
	Зависимость.ФункциональнаяОпция = ФункциональнаяОпцияИспользоватьПолнотекстовыйПоиск();
...
Процедура ИнициализироватьФункциональнуюОпциюПолнотекстовыйПоиск() Экспорт
	...
	Константы.омг_ИспользоватьПолнотекстовыйПоиск.Установить(ОперацииРазрешены);
...
Процедура ОбновлениеИндексаППДПоРасписанию() Экспорт
	...
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.омг_ОбновлениеИндексаППД);
...
Процедура СлияниеИндексаППДПоРасписанию() Экспорт
	...
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.омг_СлияниеИндексаППД);
...
Функция ВыполняетсяФоновоеЗаданиеОбновлениеИндекса()
	...
	РегламентноеЗадание = Метаданные.РегламентныеЗадания.омг_ОбновлениеИндексаППД;
...
Функция ВыполняетсяФоновоеЗаданиеСлияниеИндекса()
	...
	РегламентноеЗадание = Метаданные.РегламентныеЗадания.омг_СлияниеИндексаППД;
