...
Процедура ОбработкаРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	Если ФормаОтчета.НастройкиОтчета.ПолноеИмя = "Отчет.доп_ИсторияЗвонков" Тогда
		доп_ТелефонияКлиентПереопределяемый.доп_ИсторияЗвонковОбработкаРасшифровки(ФормаОтчета.ОтчетДанныеРасшифровки, Расшифровка, СтандартнаяОбработка);
	КонецЕсли;
