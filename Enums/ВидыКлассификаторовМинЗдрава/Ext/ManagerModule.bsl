...
//
Функция ПолучитьИмяРеквизитаDisplayNameИCode(ВидКлассификатора, Версия = Неопределено) Экспорт
	...
	ИначеЕсли ВидКлассификатора = Перечисления.ВидыКлассификаторовМинЗдрава.ЛьготныеКатегорииНаселения Тогда
		...
		Если Версия = "1.2" Тогда
			СтруктураВозвращаемогоЗначения.Вставить("Name", "NAME_SHOT");
		Иначе
	...
	ИначеЕсли ВидКлассификатора = Перечисления.ВидыКлассификаторовМинЗдрава.ПредпочтительнаяФормаПроведенияМСЭ Тогда
		СтруктураВозвращаемогоЗначения.Вставить("ЭтоКлючАтрибута_Name", Истина);
		СтруктураВозвращаемогоЗначения.Вставить("Name", "NAME_088_488_551");
	ИначеЕсли ВидКлассификатора = Перечисления.ВидыКлассификаторовМинЗдрава.ВидыПредоставляемыхЛьгот Тогда
		СтруктураВозвращаемогоЗначения.Вставить("ЭтоКлючАтрибута_Name", Истина);
		СтруктураВозвращаемогоЗначения.Вставить("Name", "PERCENT");
