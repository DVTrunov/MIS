...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	// Перечень обязательных реквизитов для элементов справочника
	...
	// Перечень обязательных реквизитов для групп справочника
...
Процедура ПередЗаписью(Отказ)
	...
	/////////////////////////////////////////////////////////////////
	// ОМГ
	Если Не ОбменДанными.Загрузка И Не ПривилегированныйРежим() 
		и не РольДоступна("ПолныеПрава") 
		И Не РольДоступна("омг_ДобавлениеИзменениеНоменклатура") Тогда
		Отказ = Истина;
	...
	Если ЗначениеЗаполнено(Упаковка)
		И Не ЗначениеЗаполнено(Ссылка.Упаковка)
		И ВидМаркированнойПродукции.Пустая()
	Тогда
		ВидМаркированнойПродукции = Перечисления.ВидыМаркированнойПродукции.МДЛП;
	КонецЕсли;
