...
Процедура ЗагрузитьИзФайла(ЗагружаемыеДанные, ПараметрыЗагрузки, Отказ) Экспорт
	...
	Для Каждого СтрокаТаблицы Из ЗагружаемыеДанные Цикл
		...
		Попытка
			...
			// Базовая единица измерения Справочники.КлассификаторЕдиницИзмерения.ПолучитьЕдиницуИзмерения(Единица, "Наименование")
			Если ЗагружаемыеДанные.Колонки.Найти("БазоваяЕдиницаИзмерения") <> Неопределено И ЗначениеЗаполнено(СтрокаТаблицы.БазоваяЕдиницаИзмерения) Тогда
				ЭлементСправочника.БазоваяЕдиницаИзмерения = Справочники.КлассификаторЕдиницИзмерения.ПолучитьЕдиницуИзмерения(СтрокаТаблицы.БазоваяЕдиницаИзмерения, "Наименование");
			КонецЕсли;
...
Процедура УстановитьЕдиницуПриЗагрузке(ЭлементСправочника, Единица, ИмяРеквизита = "ЕдиницаХраненияОстатков")
	...
	ЕдИзмСсылка = Справочники.ЕдиницыИзмерения.НайтиПоНаименованию(Единица, Истина,, ЭлементСправочника.Ссылка);
	
	Если ЗначениеЗаполнено(ЕдИзмСсылка) Тогда // Например, совпадают осн.ед. и ед.товаров.
		ЭлементСправочника[ИмяРеквизита] = ЕдИзмСсылка;
	Иначе
		...
		Если ЗначениеЗаполнено(Единица) Тогда
			...
			ЕдиницаИзмерения.ЕдиницаПоКлассификатору = Справочники.КлассификаторЕдиницИзмерения.ПолучитьЕдиницуИзмерения(Единица, "Наименование");
