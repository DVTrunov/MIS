...
Процедура НастроитьВидимостьДоступность()
	...
	Элементы.ГруппаЭтапыРабот.Видимость = ЭтоПроизводственныйРасчет;
	
	#Область Стоматология
	Если Не ЭтоПроизводственныйРасчет И Не ТолькоПросмотр Тогда 
		Объект.ЭтоЗуботехническийЗаказНаряд = Ложь;
	КонецЕсли;
	Элементы.ГруппаСтоматология.Видимость = ЭтоПроизводственныйРасчет;
	#КонецОбласти
