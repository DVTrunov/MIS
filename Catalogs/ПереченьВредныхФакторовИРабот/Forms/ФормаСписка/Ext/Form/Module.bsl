...
Процедура ПриОткрытии(Отказ)
	...
	Если ПолучитьКоличествоЭлементов() < 3 Тогда
		Если Вопрос(НСтр("ru = 'Справочник не заполнен. Загрузить перечень вредных факторов и условий работ из приказа 29н и других встроенных?'"), РежимДиалогаВопрос.ДаНет, 30) = КодВозвратаДиалога.Да Тогда
...
Процедура ЗагрузитьКлассификатор()
	...
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru ='Выполнено заполнение вредных и опасных факторов и условий работ'"));
