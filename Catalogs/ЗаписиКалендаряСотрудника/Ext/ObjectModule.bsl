...
Процедура ЗарегистрироватьИзменениеВПланеОбмена()
	...
	ЗначениеСинхронизироватьСGoogle = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Календарь, "СинхронизироватьСGoogle");
	
	Если ЗначениеСинхронизироватьСGoogle <> Неопределено И Не ЗначениеСинхронизироватьСGoogle Тогда
		Возврат;
	КонецЕсли;
