...
Процедура ТабличнаяЧастьНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Форма = ПолучитьФорму("Справочник.ВнешниеОбработки.Форма.ФормаВыбораТЧПринадлежности", Парам, ЭтаФорма.Элементы.Принадлежность);
...
Процедура ПринадлежностьПредставлениеНастроекОбработкиНачалоВыбора(Элемент, СтандартнаяОбработка)
	...
	Если ТекущиеДанные.НомерСтроки > 0 Тогда
		...
		ФормаПараметров = ПолучитьФорму("Справочник.ВнешниеОбработки.Форма.ФормаПараметровОбработки", Парам, ЭтаФорма);
...
Процедура ОткрытьФормуВыбораПринадлежности(Элемент, СсылкаОбъекта = Неопределено, РежимПодбора = Ложь)
	...
	Парам = Новый Структура;
	Парам.Вставить("РежимВыбора", Истина);
	Форма = ПолучитьФорму("Справочник.ВнешниеОбработки.Форма.ФормаВыбораПринадлежности", Парам, ЭтаФорма.Элементы.Принадлежность);
