...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.КонтактнаяИнформация") Тогда
			...
			КонтактнаяИнформацияПользователя = МодульКонтактнаяИнформацияПользователя.КонтактнаяИнформацияОбъекта(
				Пользователи.ТекущийПользователь(), Перечисления["ТипыКонтактнойИнформации"].АдресЭлектроннойПочты,,Ложь);
				
			Если КонтактнаяИнформацияПользователя <> Неопределено Тогда
