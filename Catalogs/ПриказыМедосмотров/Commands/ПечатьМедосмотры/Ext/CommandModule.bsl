...
Процедура ОткрытьФормуВыбораПечатныхФормОбъекта(Объект, ФормаВладелец) Экспорт
	...
	Попытка 
		...
		ОткрытьФорму("Справочник.ПриказыМедосмотров.Форма.ВыборПечатнойФормы", ПараметрыФормы, ФормаВладелец, , , , ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца); 
	Исключение
