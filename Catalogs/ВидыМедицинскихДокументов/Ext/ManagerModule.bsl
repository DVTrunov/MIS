...
//   - Соответствие.
//
Функция ПолучитьСопоставленийРеквизитовИXMLСправочникаЕГИСЗ(Версия = Неопределено) Экспорт
	...
	Если Версия = "2.1" Тогда
		//3) NAME, Название, Строковое, Наименование типа электронного медицинского документа;
