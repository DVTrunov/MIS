...
Процедура омг_ДопЭлементы()
	...
	ГруппаРиск = ЭтаФорма.Элементы.Добавить("ГруппаРиск", Тип("ГруппаФормы"),Элементы.ГруппаШапкаРеквизиты);
...
Процедура МаршрутыПациентаВыбор(Элемент, Строка, Поле, СтандартнаяОбработка)
	...
	ОткрытьФорму("Отчет.МаршрутЛеченияПациента.Форма.ФормаОтчета", ПараметрыФормы, ЭтотОбъект);
