...
//{{MRG[ <-> ]
		// +ОЛИМП
		// для исправления момента с подсистемой из расширения, подчиненной подсистеме конфигурации
...
//}}MRG[ <-> ]
		//	Продолжить;
		//КонецЕсли;
		ДобавлятьОбъектМетаданных = Не (ЗначениеЗаполнено(ИмяРасширения) <> ОбъектыРасширений);
		
		Если ДобавлятьОбъектМетаданных Тогда
		// -ОЛИМП
		...
		ПолныйСиноним = ?(ДобавлятьОбъектМетаданных, НоваяСтрока.ПолныйСиноним, ПолныйСинонимРодителя + СвойстваКоллекции.СинонимВЕдЧисле + ". " + Синоним);	
		//-ОЛИМП
...
//}}MRG[ <-> ]
		...
		Если ДобавлятьОбъектМетаданных Тогда //+ОЛИМП
