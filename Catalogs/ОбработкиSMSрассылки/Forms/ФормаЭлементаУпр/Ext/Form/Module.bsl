...
Функция ВыбратьФайл()
	...
	СтруктураВозврата.Вставить("ДвоичныеДанныеОбработки", ДвоичныеДанные);
...
Процедура ЗаменитьФайл(Команда)
	...
	Попытка
		ЗаменитьФайлСервер(ЗначениеВозврата.ДвоичныеДанныеОбработки);
...
Процедура ЗаменитьФайлСервер(ФайлВнешнейОбработки)
	...
	ИначеЕсли ТипЗнч(ФайлВнешнейОбработки) = Тип("ДвоичныеДанные") Тогда
		об.ХранилищеВнешнейОбработки = Новый ХранилищеЗначения(ФайлВнешнейОбработки);
	Иначе
