...
//+ОЛИМП
&НаКлиенте
Процедура доп_СохранитьПарольЭЦП(Команда)
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		ОткрытьФорму("Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования.Форма.доп_СохранениеПароляЭЦП",
...
Процедура СозданиеКнопкиСохраненияПароля()
	...
	Команда = Команды.Добавить("доп_СохранитьПарольЭЦП");
	Команда.Заголовок = "Сохранить пароль";
	Команда.Действие  = "доп_СохранитьПарольЭЦП";
	
	КнопкаФормы = Элементы.Добавить("доп_СохранитьПарольЭЦП", Тип("КнопкаФормы"), Элементы.ФормаСтандартныеКоманды);
	КнопкаФормы.ИмяКоманды = "доп_СохранитьПарольЭЦП";
