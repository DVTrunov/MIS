...
Процедура НастроитьТабличныеЧасти()
	...
	////////////////////////////////////////////////////////////////////
	// ОМГ
	омг_Договора.Параметры.УстановитьЗначениеПараметра("Объект",Объект.Ссылка);
	// ОМГ
	////////////////////////////////////////////////////////////////////
...
&НаКлиенте
Процедура омг_СоздатьДоговор(Команда)  
	
	Стр = Новый Структура;
	Стр.Вставить("Владелец",Объект.Ссылка);	
	ОткрытьФорму("Справочник.СоглашенияСтрахования.Форма.ФормаЭлемента",Стр);   
	
КонецПроцедуры    

&НаКлиенте
Процедура омг_СкопироватьДоговор(Команда)
	
	Стр = Новый Структура;
	Стр.Вставить("ЗначениеКопирования",Элементы.омг_Договора.ТекущаяСтрока);	
	ОткрытьФорму("Справочник.СоглашенияСтрахования.Форма.ФормаЭлемента",Стр);  
