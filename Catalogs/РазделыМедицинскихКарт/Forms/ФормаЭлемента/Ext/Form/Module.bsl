...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ВыводитьПротоколыВрачебныхКомиссий.Видимость = Объект.ВыводитьПротоколыВрачебныхКомиссий
		Или (Метаданные.Документы.Найти("ВрачебнаяКомиссия") <> Неопределено);
...
Процедура ДоступностьЭлементовПоВидуРаздела()
	...
	Элементы.ВыводитьПротоколыВрачебныхКомиссий.Доступность = ЭтоВыводШаблонов;
