...
// ОМГ 
&НаСервере
Процедура омг_ДопРеквизиты()
	
	НовыйЭлемент = Элементы.Добавить("ТребуетОснования",Тип("ПолеФормы"),ЭтаФорма);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеФлажка; 
	НовыйЭлемент.ПутьКДанным = "Объект.омг_ТребуетОснования";
	Элементы.Переместить(НовыйЭлемент,ЭтаФорма,Элементы.ПодвалТЧ);
	
	Если РольДоступна("ПолныеПрава") Тогда
		
	НовыйЭлемент = Элементы.Добавить("омг_Заблокировать",Тип("ПолеФормы"),ЭтаФорма);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеФлажка; 
	НовыйЭлемент.ПутьКДанным = "Объект.омг_Заблокировать";
	Элементы.Переместить(НовыйЭлемент,ЭтаФорма,Элементы.ПодвалТЧ);
