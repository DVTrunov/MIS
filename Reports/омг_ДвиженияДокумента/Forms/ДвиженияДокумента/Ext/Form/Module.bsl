...
Процедура ОбработатьВыводДанныхПоМассиву(СписокПолей, ТаблицаРесурсов, ТаблицаИзмерений, ТаблицаРеквизитов, ТаблицаВидДвижений = Неопределено, Знач ИмяРегистра, СинонимРегистра)
	...
	Макет = Отчеты.омг_ДвиженияДокумента.ПолучитьМакет("Макет");
	...
	Если Отчет.СпособВыводаОтчета = Перечисления.омг_СпособВыводаОтчета.ПоГоризонтали Тогда
...
Процедура ВывестиЖурналПроводок()
	...
	Макет 				= Отчеты.омг_ДвиженияДокумента.ПолучитьМакет("Макет");
	МакетЖурналПроводок = Отчеты.омг_ДвиженияДокумента.ПолучитьМакет("МакетЖурналПроводок");
	ОбластьЗаголовок 	= Макет.ПолучитьОбласть("ЗаголовокОтчета");
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отчет.СпособВыводаОтчета = Перечисления.омг_СпособВыводаОтчета.ПоГоризонтали;
